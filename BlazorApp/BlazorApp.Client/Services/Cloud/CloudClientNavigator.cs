...
namespace BlazorApp.Client.Services.Cloud
{
    public interface ICloudNavigator
    {
        ...
        Task<Result<IEnumerable<UploadFileResult>>> CreateCloudFilesAsync(Guid cloudId, Guid? parrentId, IEnumerable<IBrowserFile> files, bool isPersonal, CancellationToken cancellationToken = default);
        Task<Result> CreateFolderAsync(Guid cloudId, Guid? parrentId, CreateCloudFolderModel model, bool isPersonal, CancellationToken cancellationToken = default);
        ...
        Task<Result<IEnumerable<CloudItemModel>>> GetCloudItemAsync(Guid cloudId, Guid? parrentId, bool isPersonal, CancellationToken cancellationToken = default);
        ...
        Task<Result<IEnumerable<CloudModel>>> GetGlobalPageAsync(CancellationToken cancellationToken = default);
        Task<Result<IEnumerable<CloudModel>>> GetMainPageAsync(CancellationToken cancellationToken = default);
        Task<Result<CloudModel>> GetUserCloudAsync(Guid cloudId, CancellationToken cancellationToken = default);
    ...
    public class CloudClientNavigator : ICloudNavigator
    {
        ...
        public Task<Result<IEnumerable<UploadFileResult>>> CreateCloudFilesAsync(Guid cloudId, Guid? parrentId, IEnumerable<IBrowserFile> files, bool isPersonal, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        public Task<Result> CreateFolderAsync(Guid cloudId, Guid? parrentId, CreateCloudFolderModel model, bool isPersonal, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<Result<IEnumerable<CloudItemModel>>> GetCloudItemAsync(Guid cloudId, Guid? parrentId, bool isPersonal, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        public ValueTask<Result<FileUploadSettings>> GetFileUploadSettings(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        public Task<Result<IEnumerable<CloudModel>>> GetGlobalPageAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<Result<CloudModel>> GetUserCloudAsync(Guid cloudId, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
