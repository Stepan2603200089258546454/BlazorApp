...
namespace BlazorApp.Client.Services.Cloud
{
    public interface ICloudNavigator
    {
        ...
        Task<Result> CreateCloudFilesAsync(Guid cloudId, Guid? parrentId, IEnumerable<IBrowserFile> files, CancellationToken cancellationToken = default);
    ...
    public class CloudClientNavigator : ICloudNavigator
    {
        ...
        public Task<Result> CreateCloudFilesAsync(Guid cloudId, Guid? parrentId, IEnumerable<IBrowserFile> files, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
